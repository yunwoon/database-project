	...
	<div>
		...
		<div id="left" class="verticalLine">
			<div style="margin-top: 30px;">
					...
					<div class="mx-auto input-group input-group-lg"
						...
						<div class="d-inline-flex input-group-prepend">
							<button class="btn btn-outline-secondary" name="key"
								value="search_contact1" type="submit">#</button>
						</div>
				...
				<!-- 주소록  -->
				<div class="list-group" id="contact"
		...
		<div id="right">
			<div style="margin-top: 20px;">
				<form action="http://localhost:8080/smsdb/SmsServlet?key=send"
					method="post">
					<div style="margin-bottom: 40px;">
						<button type="button" class="btn btn-secondary btn-lg">
							TO <input style="display: inline-block;" type="text" name="phone"
								class="form-control">
						</button>
						<input type="hidden" name="type" value="s" />
					</div>
					<textarea name="content"
						placeholder="&nbsp;&nbsp;80자 이내로 메시지를 작성해주세요."></textarea>
					<br> <br>
